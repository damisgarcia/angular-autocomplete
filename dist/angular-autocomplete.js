...
(function() {
   ...
   *
   */
  var parseData, select2, setRemote;
  ...
  select2 = function($filter) {
    return {
      ...
      link: function(scope, element, attrs) {
        var options, templateResult, templateSelection, url;
        ...
        templateResult = function(item) {
          ...
          if (!item.hasOwnProperty('subtitleLabel')) {
            item.subtitleLabel = "";
          }
  ...
  angular.module('angular.autocomplete', []).directive('select2', select2);
